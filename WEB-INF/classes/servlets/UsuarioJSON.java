...
/**
 * Este Servlet analiza la request del tipo Get que le llega y mediante el uso de servicios, determina si un String Email esta disponible o no en la BBDD
...
public class UsuarioJSON extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			disponible = su.emailDisponible(strEmail);
