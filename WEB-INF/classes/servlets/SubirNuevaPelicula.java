...
/**
 * Este Servlet analiza la request del tipo Post que le llega y mediante el uso de servicios, crea una Pelicula en la BBDD
 * Crea una Pelicula a partir de los datos introducidos en el formulario y la intenta insertar
 * Al utilizar los atributos del contexto para las peliculas, recargamos el atributo del contexto una vez insertamos la pelicula
 * Una vez insertada, redirige el usuario a "listadoPeliculas.jsp" con un mensaje satisfactorio
 ...
 */
@WebServlet("/SubirNuevaPelicula")
public class SubirNuevaPelicula extends HttpServlet {
	...
	private Integer duracion, idAuto = null;
...
//Imágenes
				...
				try {
					...
					numfilesubidos = datos.SubirFicheros("estrenos_"+titulojpg, titulojpg); //Ctr shift G
				...
				String mensaje = "Se han creado la pelicula correctamente";
